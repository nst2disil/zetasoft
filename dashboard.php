        ...
        <div class="wrapper">
          <div class="dashboard">
            <div class="dashboard__products">
                  ...
                  <div class="products__item panel panel--white inactive">
                    <div class="panel__content">
                      ...
                      <div class="products__bottom">
                        ...
                        <button class="products__subscribe subscribe-button">Продлить подписку</button>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div class="products__block js-products-block">
                <div class="products__block-title">
                  Сервисы <img class="products__block-logo" src="./dist/img/panel-zeta.svg" alt="">
                  <div class="checkbox">
            ...
            <div class="dashboard__aside aside">
              ...
              <div class="panel panel--white panel--no-shadow">
                <div class="panel__content">
                  <div class="aside__title">Персональные данные</div>
                  <div class="profile">
                    <div class="profile__info">
                      <div class="profile__pic"></div>
                      <div class="profile__name">ООО «Кивиниеми»</div>
                    </div>
                    <div class="profile__row">
    ...
    <div class="modal" id="edit-profile-form">
      ...
      <div class="modal__container">
        ...
        <form class="modal__form form">
          ...
          <input type="submit" value="Сохранить" class="form__submit button button--block button--yellow">

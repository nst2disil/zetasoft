<?php
$files = ['index.php', 'services.php', 'products.php', 'products1c.php', 'competitions.php', 'cases.php', 'blog.php', 'contacts.php', 'about.php', 'vacancy.php', 'vacancies.php', 'dashboard.php'];

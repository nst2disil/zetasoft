<meta charset="UTF-8">
  ...
  <link rel="stylesheet" href="./dist/css/<?php echo $fileName; ?>.css?cache=<?php echo date("Y-m-d")?>">
  ...
  <script defer src="./dist/js/swiper-bundle.min.js?cache=<?php echo date("Y-m-d")?>"></script>
